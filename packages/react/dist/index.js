...
var TooltipUI2 = __toESM(require("@radix-ui/react-tooltip"));

// src/components/Tooltip/styles.ts
var TooltipUI = __toESM(require("@radix-ui/react-tooltip"));
var TooltipContent = styled(TooltipUI.Content, {
  padding: "$3 $4",
  bckground: "$gray900",
  color: "$gray100",
  fontFamily: "$default",
...
var TooltipArrow = styled(TooltipUI.Arrow, {
  fill: "$gray900"
});
...
function Tooltip(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipUI2.Provider, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipUI2.Root, __spreadProps(__spreadValues({}, props), { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipUI2.Trigger, { asChild: true, children }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipUI2.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipContent, { children: [
...
var ToastUI2 = __toESM(require("@radix-ui/react-toast"));
...
var ToastRoot = styled(ToastUI.Root, {
  padding: "$3 $4",
  background: "$gray800",
  border: "1px solid $gray600",
  borderRadius: "$sm",
...
var ToastTitle = styled(ToastUI.Title, {
  color: "$white",
  fontWeight: "$bold",
  fontSize: "$xl",
  lineHeight: "$base"
});
var ToastDescription = styled(ToastUI.Description, {
  color: "$gray200",
  fontWeight: "$bold",
  fontSize: "$sm",
  lineHeight: "$base",
...
var ToastClose = styled(ToastUI.Close, {
  position: "absolute",
  top: "$4",
  right: "$4",
  background: "none",
...
var ToastViewport = styled(ToastUI.Viewport, {
  position: "fixed",
  bottom: 0,
  right: 0,
...
function Toast(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(ToastUI2.Provider, { children: [
